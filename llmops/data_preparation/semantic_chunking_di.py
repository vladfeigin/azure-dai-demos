...
# AI Search index will be created automatically if it does not exist.
    ...
    try:    
        ...
        parser.add_argument("--index_name", required=True, help="Name of the index to be used")
        parser.add_argument("--index_semantic_configuration_name", required=False, help="Semantic configuration for the index")
